...
export const StackNavigator = () => {
  return (
    <Stack.Navigator
      // initialRouteName='Pagina2Screen'//para iniciar en la pagina 2
      screenOptions={{ 
        headerStyle: {
          elevation: 0,//para que no se vea la barra de navegacion en android
          shadowColor: 'transparent',// para que no se vea la barra de navegacion en ios
        },
        cardStyle: {
